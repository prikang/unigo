...
class _MyHelloState extends ConsumerState<RiderProfile> {
 String token = "";
var parsedToken = 0;
var logger = Logger(
        ...
        leading: Builder(
          builder: (BuildContext context) {
            return IconButton(
              ...
              color: AppColorConst.kappWhiteColor,
              onPressed: () {
                pushAndRemoveUntil(context, const UserProfile());
              },
            );
          },
        ),
                                      ...
                                      Expanded(
                                        child: SingleChildScrollView(
                                          ...
                                          child: Row(
                                            children: [
                                              Text(
                                               matchingUsers![index1]['phoneNumber'],
                                      ...
                                      Expanded(
                                        child: SingleChildScrollView(
                                          ...
                                          child: Row(
                                            children: [
                                              Text(
                                               matchingUsers![index1]['vehicleNumber'],
                                                textAlign: TextAlign.start,
                                                style: const TextStyle(
                                                  fontSize:
                                                      AppDimensions.body_15,
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: SingleChildScrollView(
                                          ...
                                          child: Row(
                                            children: [
                                              Text(matchingUsers![index1]['licenseNumber'], 
                                                textAlign: TextAlign.start,
                                                style: const TextStyle(
                                                  fontSize:
                                                      AppDimensions.body_15,
