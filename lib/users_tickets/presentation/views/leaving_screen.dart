...
class LeavingScreen extends ConsumerStatefulWidget {
...
class _MyHelloState extends ConsumerState<LeavingScreen> {
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onEditingComplete: () async {
                           loc.updateLocation(_textEditingController.text);
        ...
        onTap: () {
          if (place != 'No results found') {
            ...
            if (coordinates != null) {
              ...
              lea.setLatitude(latitude!.toDouble());
              lea.setLongitude(longitude!.toDouble());
